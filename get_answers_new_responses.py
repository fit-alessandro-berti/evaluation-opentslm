...
MODEL_NAME = "gpt-5-mini"  # Change to desired model, e.g., "gpt-4"
answers_dir = "real_answers/" + MODEL_NAME + "-python"
...
def process_prompt(filename):
    ...
    try:
        ...
        answer = response_data["output"][-1]["content"][0]["text"].strip()
